    ...
    public partial class Form9 : Form
    {
        ...
        private void Form9_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string sqlcommand =
                        @"Select book.bookid, book.title, author.fname, author.sname, category.type FROM book INNER JOIN author on book.bookid = author.authorid INNER JOIN category on category.categoryid= book.categoryid WHERE category.type = ('biography');";
